...
if (!m.quoted && !text) return conn.reply(m.chat, `${emoji} Debes enviar un texto para hacer un tagx.`, m)
...
/**
[ By @NeKosmic || https://github.com/AngxlKing7/ ]
**/  
...
handler.help = ['hidetagx']
handler.tags = ['grupo']
handler.command = ['hidetagx', 'notificarx', 'notifyx', 'tagx', 'tagallx']
handler.group = true
handler.rowner = true
